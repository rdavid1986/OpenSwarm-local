...
export const SHARED_SLASH_COMMANDS: ComposerCatalogCommand[] = [
  ...
  { id: 'slash-opencode-help', command: 'help', label: 'Help', description: 'OpenCode parity: local command help/palette. Preview only; no execution.', category: 'OpenCode', surface: 'both', enabled: true, action_kind: 'prepared', payload: { opencode_preview: true, risk: 'low', status: 'supported', requires_approval: false } },
  { id: 'slash-opencode-init', command: 'init', label: 'Init', description: 'OpenCode parity: project bootstrap candidate. Preview only; no automatic writes.', category: 'OpenCode', surface: 'both', enabled: true, action_kind: 'prepared', payload: { opencode_preview: true, risk: 'low', status: 'partial', requires_approval: false } },
  { id: 'slash-opencode-undo', command: 'undo', label: 'Undo', description: 'OpenCode parity: local undo candidate if reversible state exists. No execution.', category: 'OpenCode', surface: 'both', enabled: true, action_kind: 'prepared', payload: { opencode_preview: true, risk: 'medium', status: 'partial', requires_approval: true } },
  { id: 'slash-opencode-redo', command: 'redo', label: 'Redo', description: 'OpenCode parity: local redo candidate if reversible state exists. No execution.', category: 'OpenCode', surface: 'both', enabled: true, action_kind: 'prepared', payload: { opencode_preview: true, risk: 'medium', status: 'partial', requires_approval: true } },
  { id: 'slash-opencode-share', command: 'share', label: 'Share / Export', description: 'OpenCode parity: local export snapshot only; no external sharing.', category: 'OpenCode', surface: 'both', enabled: true, action_kind: 'prepared', payload: { opencode_preview: true, risk: 'high', status: 'partial', requires_approval: true } },
  { id: 'slash-opencode-model', command: 'model', label: 'Model', description: 'OpenCode parity: model selection request, policy gated. No switch here.', category: 'OpenCode', surface: 'both', enabled: true, action_kind: 'prepared', payload: { opencode_preview: true, risk: 'medium', status: 'partial', requires_approval: true } },
  { id: 'slash-opencode-agent', command: 'agent', label: 'Agent', description: 'OpenCode parity: agent routing request. Preview only; no agent execution.', category: 'OpenCode', surface: 'both', enabled: true, action_kind: 'prepared', payload: { opencode_preview: true, risk: 'medium', status: 'partial', requires_approval: true } },
  { id: 'slash-opencode-terminal', command: 'terminal', label: 'Terminal', description: 'OpenCode parity: terminal boundary request. Requires future approval/SafeShell.', category: 'OpenCode', surface: 'both', enabled: true, action_kind: 'prepared', payload: { opencode_preview: true, risk: 'high', status: 'blocked', requires_approval: true } },
  { id: 'slash-opencode-qa', command: 'qa', label: 'QA', description: 'OpenCode parity: local QA plan request. Dry run only.', category: 'OpenCode', surface: 'both', enabled: true, action_kind: 'prepared', payload: { opencode_preview: true, risk: 'low', status: 'partial', requires_approval: false } },
